...
const LEVOX_COMPANY_CONTEXT = `Levox Infotech is a full-service digital innovation partner and 360° branding & digital agency based in Ahmedabad, India. Founded with a vision to redefine creativity, we combine innovation with strategy to transform ideas into impactful visual stories.
Core Philosophy: "We don't chase low-cost shortcuts; we believe in high-quality results."
Key advantages: 100+ successful projects globally, deliver results in weeks (not months), 40 to 70% lower cost vs local US/UK/AU agencies (premium quality at India advantage pricing), single-vendor convenience (no juggling multiple agencies), custom original solutions, time-zone advantage (we work while they sleep).`;
...
// === LEVOX FOLLOW-UP MESSAGE FORMAT TEMPLATE ===
const LEVOX_FOLLOWUP_FORMAT = `
FOLLOW THIS EXACT FORMAT for the message. Use SPACING between sections. DO NOT write big paragraphs.
...
[1 personalized line about their work - reference something specific you noticed]

[PAIN POINT - 1-2 lines showing what they are missing or struggling with]
→ [Show what gap or weakness you identified]

[SOLUTION - 1-2 lines showing how this is solved, specific to their situation]
→ [How Levox solves it]

At Levox Infotech, we've helped businesses like yours:
• [Benefit 1 based on their industry/needs]
• [Benefit 2]
• [Benefit 3]

We bring:
• 100+ successful projects globally
• Full-service tech, design & marketing
• Custom solutions, not templates
• 40–70% cost advantage vs local agencies without compromising quality

Open to a quick chat?

=== OPTION 2 ===
[Provide a second strong variation following the same structure but focusing on a slightly different pain point, angle, or hook.]`;
...
Write a LinkedIn CONNECTION NOTE. Always provide 2 STRONG VARIATIONS.

STRICT RULES:
- Maximum 280 characters including spaces per variation
- 2-3 lines ONLY per variation
...
- Email body: 100-150 words per variation
...
- Email body is 100-150 words per variation
- Use SPACING between sections — NO big paragraphs
...
- No AI tone, no generic lines
- Use SPACING between sections — NO big paragraphs
- Suggest only 1-2 relevant opportunities
...
[1 personalized line about their work]

[PAIN POINT]
→ Show what they are missing / struggling with

[SOLUTION]
→ How we solve it (specific)
...
- Do NOT add headings like "Here is your message"
- Do NOT add tips or analysis
- ONLY return the variations
- Use SPACING — no big paragraphs
